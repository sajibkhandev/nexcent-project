...
const MarketingCard = ({image,text}) => {
  return (
    <div className='main relative w-[368px] h-[286px] rounded-lg'>
        ...
        <div className='overly absolute left-1/2 -translate-x-1/2 w-[317px] py-4 px-5 rounded-lg bg-[#F5F7FA]'>
        <h3 className='text-xl text-gray font-inter font-semibold text-center'>{text}</h3>
