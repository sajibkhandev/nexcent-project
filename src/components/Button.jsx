...
const Button = ({text,className,type}) => {
  ...
  return (
    <button className={`group text-[#ffffff] text-base font-medium font-inter bg-primary 
      ...
      py-1.5 px-5 sm:py-2 sm:px-6 md:py-3.5 md:px-8 rounded border border-transparent hover:bg-transparent hover:text-primary hover:border-primary duration-500 ${className}`}>{text} 
   {
