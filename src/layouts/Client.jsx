  ...
  return (
    <section className='py-10'>
      <Container>
        ...
        <Flex className="justify-between pt-10 pb-[65px] px-2 sm:px-6 md:px-0">
          <Image className='w-[30px] sm:w-[45px] md:w-auto' src={ImageOne} alt="Client Image" />
          <Image className='w-[30px] sm:w-[45px] md:w-auto' src={ImageTwo} alt="Client Image" />
          <Image className='w-[30px] sm:w-[45px] md:w-auto' src={ImageThree} alt="Client Image" />
          <Image className='w-[30px] sm:w-[45px] md:w-auto' src={ImageFour} alt="Client Image" />
          <Image className='w-[30px] sm:w-[45px] md:w-auto' src={ImageFive} alt="Client Image" />
          <Image className='w-[30px] sm:w-[45px] md:w-auto' src={ImageSix} alt="Client Image" />
          <Image className='w-[30px] sm:w-[45px] md:w-auto' src={ImageSeven} alt="Client Image" />
        </Flex>
...
" />
     ...
     <Flex className='flex-wrap justify-center md:justify-between pt-4 gap-y-6 md:gap-x-0 px-3 md:px-0'>
